...
class Screen(object):
    ...
    def erase_in_line(self, type_of=0, private=False):
        ...
        interval = (
            ...
            # the cursor,
            list(range(self.cursor.x, self.columns)),
            # b) erase from the beginning of the line to the cursor,
            # including it,
            list(range(0, self.cursor.x + 1)),
            # c) erase the entire line.
            list(range(0, self.columns))
        )[type_of]
    ...
    def erase_in_display(self, type_of=0, private=False):
        ...
        interval = (
            ...
            # the cursor,
            list(range(self.cursor.y + 1, self.lines)),
            # b) erase from the beginning of the display to the cursor,
            # including it,
            list(range(0, self.cursor.y)),
            # c) erase the whole display.
            list(range(0, self.lines))
        )[type_of]
