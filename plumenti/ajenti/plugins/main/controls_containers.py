...
@p('width', default='99%')
@p('emptytext', type=str, default=_('Empty'))
@p('filtering', type=bool, default=True)
@p('filterrow', type=str, default=_('Filter...'))
@p('filter', type=str, default='')
@p('addrow', type=str, default=None)
@plugin
...
@p('title', default='', bindtypes=[str, str])
@plugin
class Tab (UIElement):
    typeid = 'tab'
